...
public class PessoaDatastoreImpl implements PessoaDatastore {
    ...
    public void put(Pessoa pessoa) {
        ...
        try {
            ...
            throw new DatastoreException(BF_DESAFIO2_00007E.getCodAndDescription(), ex);
        }

        log.info(BF_DESAFIO2_00008I.getCodAndDescription(), CONST_MODEL, pessoa);
    }
    ...
    public Optional<Pessoa> get(String id, boolean throwException) {
        try {
            ...
            throw new DatastoreException(BF_DESAFIO2_00009E.getCodAndDescription(), ex);
        }

        if (throwException) {
            throw new BusinessException(String.format(BF_DESAFIO2_00010E.getCodAndDescription(), CONST_MODEL, id));
        }
